...
@Rule(
    ...
    description = "Table names must not start with the prefixes 'JSR' or 'JSD'. These prefixes are reserved and have special meanings in certain contexts. " +
        ...
        + "<b>Reference Document:</b> https://cmicglobal.sharepoint.com/:w:/t/development/EZE9BhqD2I5CiguVLLnNo-kB24zU-PP1HKhh_i-HabFKHA?e=5b4YrL " +
            "CMiC_SQL_Object_Standards.docx ",
    priority = Priority.MAJOR
)
*/
