-- Compliant examples
CREATE TABLE da.AP_MY_TABLE_TN (id NUMBER);
...
CREATE TABLE INVALIDTMP_MY_TABLE_TMP (id NUMBER); -- Noncompliant {{Table name found with invalid prefix and suffix at Line #14.}}
...
CREATE TABLE INVALIDTMP_MY_TABLE_TX (id NUMBER); -- Noncompliant {{Table name found with invalid prefix and suffix at Line #20.}}
