...
@Rule(
    ...
    name = "CMiC - Invalid prefix/suffix in Table Name",
    description = "Ensures tables follow the defined naming conventions. "
        ...
        + "Special rules apply for TMP prefixed tables.<br><br>"
        + "<b>Non-Compliance:</b> Flag any table name starting with an invalid prefix, ending with an invalid suffix, or both. " +
        "Table names starting with 'TMP_' must also end with either '_TMP' or '_TEMP'.<br><br>"
